...
#pragma warning restore CS0618
        ...
        /// </summary>
        protected override void OnReceived(byte[] buffer, int offset, int length, out bool handled)
        {
            base.OnReceived(buffer, offset, length, out handled);
            if (handled)
            {
                return;
            }
